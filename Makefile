...
basic_test: tests/basic_test.cpp include/httplib.h
    $(CXX) $(CXXFLAGS) tests/basic_test.cpp -o basic_test $(LDFLAGS)

clean:
    rm -f http_server http_client ws_server ws_client basic_test
